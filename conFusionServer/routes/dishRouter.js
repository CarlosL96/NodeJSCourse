...
dishRouter
      ...
      .then(
        (dish) => {
          ...
          if (
            ...
            res.statusCode = 401;
            res.end("You're not authorized to edit this comment");
            return;
          }
          if (dish != null && dish.comments.id(req.params.commentId) != null) {
            if (req.body.rating) {
  ...
  .delete(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    Dishes.findById(req.params.dishId)
      .then(
        (dish) => {
          if (req.user._id !== dish.comments.id(req.params.commentId)._id) {
            res.statusCode = 401;
            res.end("You're not authorized to delete this comment");
            return;
          }
          if (dish != null && dish.comments.id(req.params.commentId) != null) {
